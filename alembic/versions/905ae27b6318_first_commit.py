...
Revision ID: 905ae27b6318
Revises: 
Create Date: 2024-03-16 13:44:29.307539
...
def upgrade() -> None:
    ...
    sa.Column('credit_limit', sa.Float(precision=2), nullable=False),
    ...
    sa.Column('type', sa.VARCHAR(length=30), nullable=False),
    sa.Column('expense_budget', sa.Float(precision=2), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
